...
> **Repository:** https://git.restosuite.cn/devops-pub/ai-context
...
```bash
curl -fsSL https://git.restosuite.cn/devops-pub/ai-context/-/raw/main/Makefile -o Makefile
```
...
```bash
curl -fsSL https://git.restosuite.cn/devops-pub/ai-context/-/raw/main/cursor_rules.sh -o cursor_rules.sh
...
```bash
curl -fsSL https://git.restosuite.cn/devops-pub/ai-context/-/raw/main/cursor_rules_zh.sh -o cursor_rules_zh.sh
...
bunx skills add https://git.restosuite.cn/devops-pub/ai-context.git

# Install all skills to Cursor（跳过确认）
bunx skills add https://git.restosuite.cn/devops-pub/ai-context.git -a cursor -y
bunx skills add https://git.restosuite.cn/devops-pub/ai-context.git -a claude-code -y

# Install a specific skill
bunx skills add https://git.restosuite.cn/devops-pub/ai-context.git --skill go-jwt -a cursor
bunx skills add https://git.restosuite.cn/devops-pub/ai-context.git --skill go-jwt -a claude-code

# List available skills
bunx skills add https://git.restosuite.cn/devops-pub/ai-context.git --list
```

**Method 2: curl script (Legacy)**

```bash
curl -fsSL https://git.restosuite.cn/devops-pub/ai-context/-/raw/main/cursor_skills.sh -o cursor_skills.sh
...
```bash
curl -fsSL https://git.restosuite.cn/devops-pub/ai-context/-/raw/main/claude_rules_zh.sh -o claude_rules_zh.sh
