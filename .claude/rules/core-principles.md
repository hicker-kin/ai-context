...
AI **MUST** follow these in every interaction. See full rules:

- `@ai_go/v1/rules/core_principles.md`
- `@.ai-context/rules/core_principles.md`
- `@ai_go/v1/rules/core_principles_zh.md` (中文版)
- `@.ai-context/rules/core_principles_zh.md` (中文版)

## MUSTs

1. **No speculation** (禁止揣测): When encountering ambiguity or unclear requirements, **do NOT** guess. **MUST** ask the user for clarification.
